...
class DeliverMannually extends StatefulWidget {
  ...
  @override
  State<DeliverMannually> createState() => _DeliverMannually();
}

class _DeliverMannually extends State<DeliverMannually> {
        ...
        child: ListView(
          children: [
            ...
            buttons(context, "Submit", () {
              ...
              makePostRequestToDeliver(widget.accessToken, cylinderID);
  ...
  void makePostRequestToDeliver(String accessToken, List cylinderId) async {
